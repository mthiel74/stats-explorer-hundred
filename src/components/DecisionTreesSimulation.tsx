    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
            <div className="lg:col-span-1 space-y-4">
                <p className="text-muted-foreground text-sm">Decision Trees partition data based on feature values to make predictions. Watch how simple rules carve up the space.</p>
            ...
            <div className="lg:col-span-2 min-h-[400px]">
                <ResponsiveContainer width="100%" height={400}>
                    <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                        <CartesianGrid />
                        <XAxis type="number" dataKey="x" name="Feature X" domain={[0, 10]} />
                        <YAxis type="number" dataKey="y" name="Feature Y" domain={[0, 10]} />
